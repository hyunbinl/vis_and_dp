...
from printer import draw_plot, draw_plot_norm, draw_1d_plot, draw_lin_plot, draw_hm_temp
...
draw_lin_plot(xmas_week, "linear_raw",5500,"l0.png")
# draw_1d_plot(xmas_week, "hm_raw", "h0.png")
# draw_hm_temp(xmas_week, 7, 48, "hm_2d_raw", "hh0.png")
...
draw_lin_plot(noise,"linear_noise",5500,"l1.png")
# draw_1d_plot(noise,"hm_noise","h1.png")
# draw_hm_temp(noise, 7, 48, "hm_2d_noise", "hh1.png")
...
draw_lin_plot(noise,"linear_noise_savgol",5500,"l2.png")
# draw_1d_plot(noise,"hm_noise_savgol","h2.png")
# draw_hm_temp(noise, 7, 48, "hm_2d_savgol", "hh2.png")
...
plt.xlabel("Half-Hour index")
plt.ylabel("Aggregate Consumption (kWh)")
plt.legend(['raw','processed'],loc='lower right')
